...
<body>
    ...
    <div class="col-md-15">
      <div class="row no-gutters slider-text align-items-center justify-content-center"
        ...
        <div class="col-md-9 ftco-animate text-center">
          ...
          <p class="breadcrumbs">
            <span class="mr-1" style="color: brown;">Pets</span> |
            <span><a href="admin-inventory.php">Inventory</a></span> |
  ...
  <?php include 'phps/show-pets.php'; ?>
  ...
  <!-- update pets modal -->
  <div class="modal fade" id="updatePet" tabindex="-1" role="dialog" aria-labelledby="updatePet" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="phps/updatePet.php" method="POST" enctype="multipart/form-data">
            <div class="form-group" style="display: none;">
              <label for="recipient-name" class="col-form-label">Pet ID</label>
              <input type="text" class="form-control border" placeholder=" " name="update_pet_id" id="update_pet_id"
                required="">
            </div>
            <div class="form-group">
              <label for="recipient-name" class="col-form-label">Pet name</label>
              <input type="text" class="form-control border" placeholder=" " name="update_pet_name" id="update_pet_name"
                required="">
            </div>
            <div class="form-group">
              ...
              <input type="file" placeholder=" " name="update_file_name" id="update_file_name"
  ...
  <!-- add new pet modal -->
  <div class="modal fade" id="addNewPet" tabindex="-1" role="dialog" aria-labelledby="addNewPet" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body">
          <form action="phps/addNewPet.php" method="POST" enctype="multipart/form-data">
            <div class="form-group">
              <label for="recipient-name" class="col-form-label">Pet Name</label>
              <input type="text" class="form-control border" placeholder=" " name="pet_name" id="pet_name" required="">
            </div>
            <div class="form-group">
              <label for="recipient-name" class="col-form-label">Image File</label> <br />
              <label for="file_name" class="btn btn-primary py-2 px-4">Upload Image</label>
              <input type="file" placeholder=" " name="file_name" id="file_name" required="Please select image"
                style="visibility: hidden;">
  ...
  <!-- delete pet modal -->
  <div class="modal fade" id="deletePetModal" tabindex="-1" role="dialog" aria-labelledby="deletePetModal"
    aria-hidden="">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body">
          <form action="phps/deletePet.php" method="GET">
            <h3>
              Are you sure want to delete pet?
            </h3>
            (This can't be undone. It will also delete all pet related products.) <br /><br />
            <div class="form-group" style="display: none;">
              <input type="text" class="form-control border" placeholder=" " name="delete_pet_id" id="delete_pet_id"
                required="">
            </div>
            <div class="right-w3l">
